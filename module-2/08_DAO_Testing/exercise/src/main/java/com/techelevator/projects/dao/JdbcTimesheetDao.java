...
public class JdbcTimesheetDao implements TimesheetDao {
    ...
    public Timesheet createTimesheet(Timesheet newTimesheet) {
        ...
        Integer newTimesheetId = jdbcTemplate.queryForObject(sql, Integer.class,
                newTimesheet.getEmployeeId(), newTimesheet.getProjectId(), newTimesheet.getDateWorked(), newTimesheet.getHoursWorked(), newTimesheet.isBillable(),
    ...
    public void updateTimesheet(Timesheet updatedTimesheet) {
        ...
        jdbcTemplate.update(sql,
                ...
                updatedTimesheet.getProjectId(),
                updatedTimesheet.getDateWorked(),
                updatedTimesheet.getHoursWorked(),
