...
public class Exercise02_BoardingGate {
    ...
    public static void main(String[] args) {
        System.out.println(getNumberOfFullRows(new boolean[]{false, false, false, true, true, true}));
        System.out.println(getNumberOfFullRows(new boolean[]{true, true, true, true, true, true}));
        System.out.println(getNumberOfFullRows(new boolean[]{false, true, true, false, true, true}));
    }
    /*
