...
public class Lecture {
	...
	public static void main(String[] args) {
		...
		*/
		...
		your phone.
		*/
          double phoneBatteryLife = 0.88;
		  System.out.println("Battery Life " + phoneBatteryLife);
//		  Use the "()" to turn the "phoneBatteryLife" class from a double to an int when we print it out.
		  phoneBatteryLife = 0.01;
		  System.out.println("Battery Life " + (int)(phoneBatteryLife * 100) + "%");
		/*
		...
		*/
		String fullName = "Emily LeFebvre";
