...
public class JdbcParkDaoTests extends BaseDaoTests {
    ...
    public void setup() {
        ...
        testPark = new Park(0, "Test Park", LocalDate.parse("2000-01-01"), 99, false);
    }

    @Test
    public void getPark_returns_correct_park_for_id() {
        sut = new JdbcParkDao(dataSource);
        Park parkTest = new Park(3, "ParkTest", LocalDate.parse("2000-01-01"), 300, false);
    }
    ...
    public void updated_park_has_expected_values_when_retrieved() {
        ...
        parkToUpdate.setDateEstablished(LocalDate.parse("2000-01-01"));
